<x-layouts.plantilla titulo="Tipo Ventas" meta-description="Tipo Ventas meta description">
    {{-- CONTENIDO DEL MODULO TIPO-VENTA --}}

    <div class="container-fluid">

        <h1 class="text-center mt-2"> Tipo de Ventas </h1>
                    ...
                    <div class="card-header border-bottom shadow">
                        <div class="row justify-content-between py-1">
                            <div class="col-3 text-center">
                                <a href="{{ route('ven.index') }}" class="btn btn-outline-secondary bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Ver los Registros de las Ventas"><span
                                        class="d-none d-lg-inline-block">Regresar a Tabla Ventas</span>
                                    <i class="bi bi-handbag"></i> </a>
                            </div>
                            <div class="col-3 text-center">
                                <a href="{{ route('tpven.create') }}" class="btn btn-success bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Crear Nuevo Registro"> <i class="bi bi-plus-circle"></i>
                                    <span class="d-none d-sm-inline-block">{{ __('Crear Nuevo') }}</span> </a>
                            </div>
                            <div class="col-3 text-center">
                                <a href="{{ route('tpven.archive') }}" class="btn btn-danger bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <td class="col-3 text-center">
                                                ...
                                                @if (Auth::user()->tipo_usuarios_id == 1 || Auth::user()->tipo_usuarios_id == 2)
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-danger mb-1"
                                                        ...
                                                        data-bs-target="#modal-deshabilitar-{{ $tipoVenta->id }}"><i
                                                            class="bi bi-archive-fill"></i>
                                                    </button>
                                                @endif
                                            </td>
                                        </tr>
                                        @include('tipo-venta.deshabilitar')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
