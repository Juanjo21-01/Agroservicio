<x-layouts.plantilla titulo="Conversiones Deshabilitadas"
    meta-description="Conversiones deshabilitadas meta description">
    {{-- CONTENIDO DEL MODULO Conversiones --}}

    <div class="container-fluid">

        <h1 class="text-center mt-2"> Unidad de Medidas Deshabilitadas </h1>
                    ...
                    <div class="card-header border-bottom shadow">
                        <div class="row justify-content-between py-1">
                            <div class="col-12 text-center">
                                <a href="{{ route('con.index') }}" class="btn btn-outline-success bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Ver los Registros de las Conversiones"><span
                                        class="d-none d-lg-inline-block">Regresar a Tabla de Unidad de Medidas</span> <i
                                            ...
                                            <td class="col-3 text-center">
                                                @if (Auth::user()->tipo_usuarios_id == 1 || Auth::user()->tipo_usuarios_id == 2)
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-success mb-1"
                                                        ...
                                                        data-bs-target="#modal-restaurar-{{ $conversione->id }}"><i
                                                            class="bi bi-file-arrow-up"></i> Restaurar
                                                    </button>
                                                @endif
                                            </td>
                                        </tr>
                                        @include('conversion.restaurar')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
