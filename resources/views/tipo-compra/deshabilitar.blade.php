 ...
 <div class="modal fade" id="modal-deshabilitar-{{ $tipoCompra->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
     tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered">
         <form action="{{ route('tcom.destroy', $tipoCompra->id) }} " method="POST">
             @csrf
             @method('DELETE')
             ...
             <div class="modal-content">
                 <div class="modal-header">
                     <h1 class="modal-title fs-5 text-danger" id="staticBackdropLabel">
                         Deshabilitar Registro del Tipo Compra</h1>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <div class="modal-body">
                     ¿Desea deshabilitar el registro No.
                     {{ $tipoCompra->id . ', del Tipo Compra: ' . $tipoCompra->nombre }}?
                 </div>
