<x-layouts.plantilla titulo="Tipo Compras Deshabilitadas"
    meta-description="Tipo Compras deshabilitadas meta description">
    {{-- CONTENIDO DEL MODULO TIPO-COMPRA --}}

    <div class="container-fluid">

        <h1 class="text-center mt-2"> Tipo de Compras Deshabilitadas </h1>
                    ...
                    <div class="card-header border-bottom shadow">
                        <div class="row justify-content-between py-1">
                            <div class="col-12 text-center">
                                <a href="{{ route('tcom.index') }}" class="btn btn-outline-success bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Ver los Registros de los Tipos de Compras"><span
                                        class="d-none d-lg-inline-block">Regresar a Tabla Tipo de Compras</span> <i
                                            ...
                                            <td class="col-3 text-center">
                                                @if (Auth::user()->tipo_usuarios_id == 1 || Auth::user()->tipo_usuarios_id == 2)
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-success mb-1"
                                                        ...
                                                        data-bs-target="#modal-restaurar-{{ $tipoCompra->id }}"><i
                                                            class="bi bi-file-arrow-up"></i> Restaurar
                                                    </button>
                                                @endif
                                            </td>
                                        </tr>
                                        @include('tipo-compra.restaurar')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
