<x-layouts.plantilla titulo="Tipo Clientes" meta-description="Tipo Clientes meta description">
    {{-- CONTENIDO DEL MODULO TIPO-CLIENTE --}}

    <div class="container-fluid">

        <h1 class="text-center mt-2"> Tipo de Clientes </h1>
                    ...
                    <div class="card-header border-bottom shadow">
                        <div class="row justify-content-between py-1">
                            <div class="col-3 text-center">
                                <a href="{{ route('cl.index') }}" class="btn btn-outline-secondary bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Ver los Registros de los Clientes"><span
                                        class="d-none d-lg-inline-block">Regresar a Tabla Clientes</span> <i
                                        class="bi bi-person-up"></i> </a>
                            </div>
                            <div class="col-3 text-center">
                                <a href="{{ route('tpcl.create') }}" class="btn btn-success bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Crear Nuevo Registro"> <i class="bi bi-plus-circle"></i>
                                    <span class="d-none d-sm-inline-block">{{ __('Crear Nuevo') }}</span> </a>
                            </div>
                            <div class="col-3 text-center">
                                <a href="{{ route('tpcl.archive') }}" class="btn btn-danger bg-gradient"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <td class="col-3 text-center">
                                                ...
                                                @if (Auth::user()->tipo_usuarios_id == 1 || Auth::user()->tipo_usuarios_id == 2)
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-danger mb-1"
                                                        ...
                                                        data-bs-target="#modal-deshabilitar-{{ $tipoCliente->id }}"><i
                                                            class="bi bi-archive-fill"></i>
                                                    </button>
                                                @endif
                                            </td>
                                        </tr>
                                        @include('tipo-cliente.deshabilitar')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
