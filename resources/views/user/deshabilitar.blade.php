 ...
 <div class="modal fade" id="modal-deshabilitar-{{ $usuario->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
             ...
             <div class="modal-content">
                 <div class="modal-header">
                     <h1 class="modal-title fs-5 text-danger" id="staticBackdropLabel">
                         Deshabilitar Registro del Usuario</h1>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <div class="modal-body">
                     ¿Desea deshabilitar el usuario: {{ $usuario->name }}?
                 </div>
